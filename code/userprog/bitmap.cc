 ...
 * 
 * We keep a numOfSetBits to allow for more efficient
 * counting of bit set to one. (especially useful to keep track of user threads).
 * 
 * @return Returns the number of bits set to 1 in the bitmap
 */
int BitMap::NumSet()
{
    return numOfSetBits;
