...
#define DATAMAXSIZE 10 // la longueur de tous nos messages
...
public:
  ...
  void Send2(PacketHeader pktHdr, MailHeader mailHdr, const char *data);
  void Receive2(int box, PacketHeader *pktHdr, MailHeader *mailHdr, char *data);
